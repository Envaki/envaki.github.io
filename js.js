...
function red() {
    ...
    r.style.background = 'url(https://envaki.github.io/img/img1.jpg) no-repeat center'
    r.style.background-size = 'cover'
...
function green() {
    ...
    t.style.background = 'url(https://envaki.github.io/img/img2.jpg) no-repeat center'
